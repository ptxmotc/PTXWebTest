...
* \[逐筆更新\]與\[批次更新\]之資料服務差異\(目前僅**公總及其代管縣市**提供逐筆更新\)

|  | 逐筆更新 | 批次更新 |
| :--- | :--- | :--- |
| 通訊方式 | UDP | TCP |
| 特色 | 資料可能丟失，但延遲時間較少 | 保證資料送達，但延遲時間較多 |
| N1資料之預估到站時間 | 僅在公車離站時觸發車機更新\(不提供自動倒數※\) | 每1分鐘公總會更新一次\(由公總加值\)，但仍需注意在下一次更新前的延遲時間 |
| 資料整併 | 公總無額外處理：同一站同一路線將有多筆預估到站時間 | 公總提供額外加值：將同一站同一路線的多筆預估到站時間整併，提供最快到站的時間 |

※使用者需自行處理時間遞減機制，或以EstimateTime-\(收到資料時間-SrcTransTime\)作為實際預估抵達時間。
